...
<body>
    ...
    <script>
        ...
        function get_records() {
            ...
            let _site_url = $('meta[name="site_url"]').attr('content');
            $.ajax({
                //debugger;
                url: _site_url+'/post/all',
                type: "post",
                dataType: "json",
                async: false
                // data: form_data,
        ...
        $(document).on('click', '.view', function () {
            ...
            $.ajax({
                //debugger;
                url: _site_url+'/post/view_record',
                type: "post",
                dataType: "json",
                //                    async: false
                data: { id: id },
        ...
        $(document).on('click', '.update', function (event) {
            ...
            $.ajax({
                //debugger;
                url: _site_url+'/post/update_record',
                type: "post",
                dataType: "json",
                //                    async: false
                data: form_data,
        ...
        $("#delete_button").on('click',  function (event) {
            ...
            $.ajax({
                //debugger;
                url: _site_url+'/post/delete_record',
                type: "post",
                dataType: "json",
                //                    async: false
                data: { id: id },
